...
export default function ContactSection({
  ...
  return (
    <section ref={sectionRef} id="contact" className="mb-24 max-w-6xl mx-auto px-4" suppressHydrationWarning>
      {/* Section Header */}
      <header className="mb-12 text-left">
        ...
        <h2
          ref={headlineRef}
          className="text-4xl md:text-5xl font-unbounded font-black text-black dark:text-white mb-4 will-change-[clip-path]"
      ...
      <div className="max-w-2xl" suppressHydrationWarning>
        <div ref={formCardRef} className="bg-zinc-50 dark:bg-zinc-900 p-6 md:p-8 rounded-2xl" suppressHydrationWarning>
            ...
            {submitStatus === 'success' ? (
              ...
              >
                ...
                <button
                  ...
                  className="w-full py-4 bg-primary text-primary-foreground font-unbounded font-bold text-sm tracking-wide uppercase rounded-lg hover:opacity-90 active:scale-[0.97] transition-all duration-150 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {isSubmitting ? (
                    <>
